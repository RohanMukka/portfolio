          ...
          <div className="space-y-6">
            <div className="flex flex-wrap gap-2">
              {tags.slice(0, 3).map((tag) => (
                <span
                  key={tag}
                  className="text-xs font-medium px-3 py-1.5 rounded-lg bg-glass-bg text-primary-text border border-glass-border transition-colors group-hover:bg-primary-blue/10 group-hover:border-primary-blue/30"
                >
                  {tag}
                </span>
              ))}
            ...
            <div className="flex items-center gap-4 pt-4 border-t border-glass-border">
              {links.github && (
                <a
                  ...
                  className="flex items-center gap-2 text-primary-text font-medium hover:text-electric-cyan transition-colors"
